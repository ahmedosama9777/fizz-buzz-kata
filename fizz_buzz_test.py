...
class TestFizzBuzz(TestCase):
    ...
    def test_input_less_than_range(self):
        ...
        self.assertEqual(str(e.exception), "Number must be greater than 0")

    def test_input_greater_than_range(self):
        with self.assertRaises(ValueError) as e:
            self.fizz_buzz.run(101)
        self.assertEqual(str(e.exception), "Number must be less than 100")
